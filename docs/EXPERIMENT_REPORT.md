...
| :---: | :---: | :---: | :---: | :--- |
| 32 | **0.7495** | - | 43 | ✅ 比舊 64-bit 好 |
| 64 (重跑) | **0.7751** | 0.9731 | 49 | ✅ 校正後正常 (符合趨勢) |
| 128 | **0.7899** | - | - | ✅ 提升 (+1.48%) |
| 256 | **0.8045** | 0.9781 | 48 | ✅✅ 最佳表現 |

#### 3. 綜合分析 (修正版)

1. **謎團解開**：原先 64-bit 的低效能 (0.6787) 證實是因為訓練不足 (僅 20 epochs)。重跑後提升至 **0.7751**。
2. **Scaling Law 成立**：效能隨 Hash Bits 增加而穩定提升，呈現邊際效應遞減：
   - `32 -> 64`: +2.56%
   - `64 -> 128`: +1.48%
   - `128 -> 256`: +1.46%
